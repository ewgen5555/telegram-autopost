...
Автопостинг развивающих игр, заданий, советов и историй в Telegram-канал [@kids_brain_37](https://t.me/kids_brain_37).

## Как это работает

- `generator.py` — собирает текст поста из шаблонов (категории: `game`, `task`, `tip`, `story`), добавляет релевантные хештеги и подбирает картинку.
- `images.py` — тематические картинки под каждую категорию (пока через picsum).
...
- 12 шаблонов игр + 8 заданий + 8 советов + 6 историй
- Автоматические хештеги по категории, навыку и возрасту
- Взвешенный выбор категорий (больше игр и заданий)
- Два случайных навыка в строке «Развивает»
